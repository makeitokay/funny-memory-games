...
from skill.texts import MAIN_MENU_HELP, TRIP_GAME_QUIZ_HELP, TRIP_GAME_EXCURSION_HELP, TRIP_GAME_END_HELP, \
    ANTONYMS_GAME_HELP, ANTONYMS_GAME_END_HELP, PROFESSIONS_GAME_ANSWER_HELP, PROFESSIONS_GAME_NEXT_HELP, \
    PROFESSIONS_GAME_END_HELP, WHAT_YOU_CAN_TEXT


class HelpHandler(Handler):
    HELP_KEYWORDS = ["помощь", "помоги", "я запутался", "запуталась", "ничего не понятно"]
